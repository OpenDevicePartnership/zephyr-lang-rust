...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_TI_TMP11X_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TMP11X, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TMP11X_TRIGGER_NONE, 1);
